...
@interface YZPixelBufferCapture ()<AVCaptureVideoDataOutputSampleBufferDelegate>
...
@implementation YZPixelBufferCapture
- (void)dealloc
{
    [NSNotificationCenter.defaultCenter removeObserver:self];
    NSLog(@"YZPixelBufferCapture---dealloc");
}
